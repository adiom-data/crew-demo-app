...
// period.
const (
	// SampleServiceGetSessionProcedure is the fully-qualified name of the SampleService's GetSession
	// RPC.
	SampleServiceGetSessionProcedure = "/sample.v1.SampleService/GetSession"
)
...
func NewSampleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SampleServiceClient {
	...
	return &sampleServiceClient{
		getSession: connect.NewClient[v1.GetSessionRequest, v1.GetSessionResponse](
			httpClient,
			baseURL+SampleServiceGetSessionProcedure,
			connect.WithSchema(sampleServiceMethods.ByName("GetSession")),
...
// GetSession calls sample.v1.SampleService.GetSession.
func (c *sampleServiceClient) GetSession(ctx context.Context, req *connect.Request[v1.GetSessionRequest]) (*connect.Response[v1.GetSessionResponse], error) {
...
func NewSampleServiceHandler(svc SampleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	sampleServiceMethods := v1.File_sample_v1_sample_proto.Services().ByName("SampleService").Methods()
	sampleServiceGetSessionHandler := connect.NewUnaryHandler(
		SampleServiceGetSessionProcedure,
		svc.GetSession,
		connect.WithSchema(sampleServiceMethods.ByName("GetSession")),
	...
	return "/sample.v1.SampleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case SampleServiceGetSessionProcedure:
			sampleServiceGetSessionHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedSampleServiceHandler) GetSession(context.Context, *connect.Request[v1.GetSessionRequest]) (*connect.Response[v1.GetSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("sample.v1.SampleService.GetSession is not implemented"))
}
